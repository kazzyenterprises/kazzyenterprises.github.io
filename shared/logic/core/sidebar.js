// js/components/sidebar.js (renamed to sidebar.js in shared/logic/core)
        ...
        <ul>
            ...
            <li>
                ...
                <ul class="submenu">
                    ...
                    <li><a href="#shops/places-manage" data-route="shops/places-manage"><i class="fa-solid fa-location-dot"></i> Places</a></li>
                    <li><a href="#shops/manage" data-route="shops/manage"><i class="fa-solid fa-gear"></i> Manage Shops</a></li>
                    <li><a href="#shops/images" data-route="shops/images"><i class="fa-regular fa-image"></i> Shop Images</a></li>
                </ul>
            </li>
            ...
            <li>
                ...
                <ul class="submenu">
                    <li><a href="#products/catalog" data-route="products/catalog"><i class="fa-solid fa-boxes-stacked"></i> Product Catalog</a></li>
                    <li><a href="#products/manage" data-route="products/manage"><i class="fa-solid fa-pen-to-square"></i> Manage Products</a></li>
            ...
            <li>
                ...
                <ul class="submenu">
                    <li><a href="#delivery/plan" data-route="delivery/plan"><i class="fa-solid fa-route"></i> Delivery Plan</a></li>
                    <li><a href="#delivery/orders" data-route="delivery/orders"><i class="fa-solid fa-box-open"></i> Delivery Orders</a></li>
                </ul>
            </li>

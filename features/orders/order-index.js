...
import { registerRoute } from "../../shared/logic/core/router.js";
import { loadComponent } from "../../shared/utils/js/component-loader.js";
...
registerRoute("orders/new-order", async () => {
    ...
    await loadComponent("features/orders/templates/pages/new-order.html", "main-content-area");
    
    try {
        // FIX: Using the ABSOLUTE (root-relative) path for the dynamic import.
        const { initializeOrderPage } = await import("/features/orders/js/pages/new-order.js"); 
...
registerRoute("orders/edit-orders", async () => {
    await loadComponent("features/orders/templates/pages/edit-orders.html", "main-content-area");

    try {
        // 2. FIX: Use the ABSOLUTE (root-relative) path for the dynamic import.
        const { initializeEditOrdersPage } = await import("/features/orders/js/pages/edit-orders.js");

...
import { updateOrderStandalone, deleteOrderStandalone as deleteOrderService } from '../../../../shared/logic/api/orders/edit-order-service.js';
...
import { loadOrdersListTable } from '../../../../shared/utils/js/orders-list-table.js';
import { loadOrderItemTable } from '../../../../shared/utils/js/order-item-table.js';
...
export class EditOrderController {
  ...
  async _loadOrderForEdit(orderId) {
    ...
    this.orderItemTable = await loadOrderItemTable('shared-order-table-container');
